                    ...
                    <div className="flex flex-col justify-center items-center pt-10 pb-20">
                        <div className="flex flex-col justify-center items-center">
                            <Link href="https://facebook.com/atom.parit.ch" target="_blank" passHref={true} className="w-40 h-40 rounded-full bg-gray-300 hover:scale-105">
                                <img className="rounded-full" src="/Atom.jpg" alt="Atom's img" width="500" height="250"></img>
                            </Link>
                        ...
                        <div className="flex flex-col justify-center items-center pt-14">
                            <Link href="https://facebook.com/chin.katedee" target="_blank" passHref={true} className="w-40 h-40 rounded-full bg-gray-300 hover:scale-105"><img className="rounded-full" src="/Chin.jpg" alt="Sahachindech's img" width="500" height="250"></img></Link>
                            <p className="pt-4">65070232</p>
                            <h1 className="text-2xl font-bold">Sahachindech Katedee</h1>
                            <p className="text-lg">Web developer</p>
                        </div>
                        <div className="flex flex-col justify-center items-center pt-14">
                            <Link href="https://facebook.com/profile.php?id=100010782515688" className="w-40 h-40 rounded-full bg-gray-300 hover:scale-105"><img className="rounded-full" src="/Mos.jpg" alt="Mos's img" width="500" height="250"></img></Link>
