...
export default function Home() {
  return <PageWrapper>
      <div className='place-content-center bg-gradient-to-t from-lime-700 to-yellow-50 scrollbar'>
        ...
        <div className='w-full px-24 flex justify-center pb-6'>
          <div className='p-5 bg-stone-200 rounded-md drop-shadow-xl'>
            <div className='text-lg'><strong className='text-xl pb-2'>บทคัดย่อ</strong><br/> โครงงานนี้ เป็นโครงงานประเภทเกม ทำขึ้นเพื่อศึกษาและเพิ่มความเข้าใจในภาษา C โดยตัวเกมเป็นเกมประเภทตอบคำถามความรู้รอบตัวในหมวดหมู่ที่หลากหลาย ซึ่งประกอบไปด้วยฟังก์ชั่นต่าง ๆ เพื่อเพิ่มความท้าทายในการเล่น มีจุดมุ่งหมายเพื่อให้ผู้เล่นได้รับความรู้ไปพร้อมกับความสนุก</div>
          </div>
        </div>
